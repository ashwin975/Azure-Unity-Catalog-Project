...
USING json
OPTIONS (path "abfss://bronze@databricksucextdl101.dfs.core.windows.net/drivers.json")
...
USING json
OPTIONS (path "abfss://bronze@databricksucextdl101.dfs.core.windows.net/results.json")
